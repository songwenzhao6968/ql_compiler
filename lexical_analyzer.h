...
int main() 
{
    char File[128];
    FILE* fd;
    cout << "请输入需要进行词法分析的文件名（例：test.txt）：";
    while(true) 
	{
        cin >> File;
        cout << "File" << endl;
...
void output(string& word, int number) 
{
    if(number < 0){
        ...
        cout << setw(3) << number << "   " << setw(6) << word << "  关键字" << endl;
    } else if(number < 100){
        cout << setw(3) << number << "   " << setw(6) << word << "  操作符" << endl;
    } else if(number < 200){
        cout << setw(3) << number << "   " << setw(6) << word << "  界符" << endl;
    } else if(number == 200){
        cout << setw(3) << number << "   " << setw(6) << word << "  整数" << endl;
    } else if(number == 201){
        cout << setw(3) << number << "   " << setw(6) << word << "  浮点数" << endl;
    } else if(number == 202){
        cout << setw(3) << number << "   " << setw(6) << word << "  字符串" << endl;
    } else if(number == 300){
        cout << setw(3) << number << "   " << setw(6) << word << "  标识符" << endl;
    }
}
